...
-- Reourses
MovementHandler.ReplicatedStorageDirectory = game.ReplicatedStorage:WaitForChild("Modules"):WaitForChild("MovementHandler")
...
MovementHandler.Configurations.SlideEnabled = false
MovementHandler.Configurations.CrouchEnabled = true
MovementHandler.Configurations.ProneEnabled = false
